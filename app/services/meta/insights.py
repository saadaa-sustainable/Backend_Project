        ...
        try:
            for level in levels:
                ...
                for combo in breakdown_combos:
                    ...
                    try:
                    ...
                    except Exception as exc:  # noqa: BLE001 -- isolated per (level, combo) on purpose:
                        # one level exhausting its retries (confirmed live 2026-08-20 that Meta's
                        ...
                        # must not discard every OTHER level that already succeeded. Mirrors
    ...
    async def _sync_one(
        ...
        *,
        ...
        if use_async:
            ...
            item_iterator = self.client.paginate_async_report(report_run_id)
        else:
            item_iterator = self.client.paginate(insights_path, params=params, page_size=page_size)
